...
final List<Service> sections = [
  Service(
    ...
    photo: "assets/images/educator.jpg",
  ),
  Service(
    name: "Mentor", 
    ...
    photo: "assets/images/mentor.jpg", 
  ),
  Service(
    name: "Counselor", 
    ...
    photo: "assets/images/counselor.jpg", 
  ),
  Service(
    name: "Trainer/Coach", 
    ...
    photo: "assets/images/trainer_coach.jpg", 
  ),
  Service(
    ...
    photo: "assets/images/conversationalist.jpg",
  ),
  Service(
    name: "iBARE", 
    title: "iBARE", 
